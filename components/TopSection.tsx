...
const TopSection: FunctionComponent<TopSectionProps> = () => {
    return ( 
        ...
        <>
         <section className="recommended-block section-top-spacing">
        <div className="container-fluid">
          <div className="overflow-hidden">
            <div
              className="d-flex align-items-center justify-content-between px-3 my-4"
            >
            ...
            <div className="card-style-slider">
              ...
              >
                <ul className="p-0 swiper-wrapper m-0 list-inline" style={{
                      transform: "translate3d(-360px, 0px, 0px)", 
                      transitionDuration: "0ms"
                }}>
                  <li className="swiper-slide"  style={{
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/01.html"
                            alt="movie-card"
                        ...
                        <div className="block-social-info align-items-center">
                          <ul className="p-0 m-0 d-flex gap-2 music-play-lists">
                            <li
                              className="share position-relative d-flex align-items-center text-center mb-0"
                            >
                              <span
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/02.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/03.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/04.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/05.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/06.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/popular/07.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
