...
interface DocumentaryMovieBlockProps {}

const DocumentaryMovieBlock: FunctionComponent<
  DocumentaryMovieBlockProps
> = () => {
  return (
    <>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/01.html"
                            alt="movie-card"
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/02.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/03.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/04.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/05.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/06.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/related/07.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
...
export default DocumentaryMovieBlock;
