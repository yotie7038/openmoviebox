  ...
  return (
    <>
      <div
        className="vh-100"
        style={{
          background: "url('/assets/images/pages/01.html')",
            ...
            <div className="col-lg-5 col-md-12 align-self-center">
              <div className="user-login-card bg-body">
                ...
                <form action="https://templates.iqonic.design/streamit-dist/frontend/html/post">
                  <div className="mb-3">
                    <label className="text-white fw-500 mb-2">
                  ...
                  <div className="mb-3">
                    <label className="text-white fw-500 mb-2">Password</label>
                    <input
                      type="password"
                      className="form-control rounded-0"
                      required
                  ...
                  <label className="list-group-item d-flex align-items-center mb-3 font-size-14 text-white fw-500">
                    <input
                ...
                <ul className="p-0 pt-4 m-0 list-unstyled widget_social_media text-center">
                  <li>
                    <a
                      href="https://templates.iqonic.design/www.google.com/"
                  ...
                  <li>
                    <a
                      href="https://templates.iqonic.design/facebook.com/"
                      className="position-relative"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li>
                    <a
                      href="https://templates.iqonic.design/twitter.com/"
                      className="position-relative"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
