...
const BottomBlock: FunctionComponent<BottomBlockProps> = () => {
    return ( 
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/01.html"
                            alt="movie-card"
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/02.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/03.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/04.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/05.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/06.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/recommended/07.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
