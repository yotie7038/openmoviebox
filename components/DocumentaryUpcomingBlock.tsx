...
interface DocumentaryUpcomingBlockProps {}

const DocumentaryUpcomingBlock: FunctionComponent<
  DocumentaryUpcomingBlockProps
> = () => {
  return (
    <>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/01.html"
                            alt="movie-card"
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/02.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/03.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/04.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/05.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/06.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
                    ...
                    <div className="iq-card card-hover">
                      <div className="block-images position-relative w-100">
                        <div className="img-box w-100">
                          ...
                          ></a>
                          <img
                            src="assets/images/movies/upcoming/07.html"
                            alt="movie-card"
                            className="img-fluid object-cover w-100 d-block border-0"
                          />
                        </div>
...
export default DocumentaryUpcomingBlock;
