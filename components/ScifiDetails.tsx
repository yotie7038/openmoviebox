...
interface ScifiDetailsProps {}

const ScifiDetails: FunctionComponent<ScifiDetailsProps> = () => {
  return (
    <>
              ...
              <div className="trending-info mt-4 pt-0 pb-4">
                <div className="row">
                  <div className="col-md-9 col-12 mb-auto">
                    ...
                    <ul className="p-0 mt-2 list-inline d-flex flex-wrap movie-tag">
                      <li className="trending-list">
                        <a className="text-primary" href="view-all-movie.html">
                          Scifi
                        </a>
                      </li>
                      <li className="trending-list">
                    ...
                    <div className="d-flex flex-wrap align-items-center text-white text-detail flex-wrap mb-4">
                      ...
                      <span className="ms-3 font-Weight-500 genres-info me-1">
                        1hr : 48mins
                      </span>
                    ...
                    <div className="d-flex align-items-center gap-4 flex-wrap mb-4">
                      <ul className="list-inline p-0 share-icons music-play-lists mb-n2 mx-n2">
                        ...
                        <li>
                          <span>
                            <a href="assets/images/video/trailer.mp4" download>
                      ...
                      <div className="movie-detail-select">
                        <select
                          name="movieselect"
                          className="form-control movie-select select2-basic-single js-states"
                        >
                    ...
                    <ul className="iq-blogtag list-unstyled d-flex flex-wrap align-items-center gap-3 p-0">
                      ...
                      <li>
                        <a className="title" href="view-all-movie.html">
                          Scifi
                        </a>
                  ...
                  <div className="trailor-video col-md-3 col-12 mt-lg-0 mt-4 mb-md-0 mb-1 text-lg-right">
                    ...
                    >
                      <img
                        src="assets/images/genre/01.html"
                  ...
                  >
                    <div className="description-content">
                      <p>
                        ...
                        horror film based on Hanna-Barbera's Scooby-Doo
                        Saturday-morning cartoons. In the film, Shaggy, Scooby,
                        Fred, Velma, and Daphne reunite after a year-long hiatus
                        from Mystery, Inc. to investigate a bayou island said to
                        be haunted by the ghost of the pirate Morgan Moonscar.
                        The film was directed by Jim Stenstrum, from a
