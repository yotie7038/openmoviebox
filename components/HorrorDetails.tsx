...
interface HorrorDetailsProps {
    
}
 
const HorrorDetails: FunctionComponent<HorrorDetailsProps> = () => {
    return ( 
          ...
          <div className="row">
            <div className="col-md-9 col-12 mb-auto">
              ...
              <ul className="p-0 mt-2 list-inline d-flex flex-wrap movie-tag">
                <li className="trending-list"><a className="text-primary" href="view-all-movie.html">Horror</a></li>
              ...
              <ul className="iq-blogtag list-unstyled d-flex flex-wrap align-items-center gap-3 p-0">
                ...
                <li><a className="title" href="view-all-movie.html">Horror</a><span className="text-secondary">,</span></li>
