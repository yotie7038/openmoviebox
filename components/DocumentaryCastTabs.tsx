...
interface DocumentaryCastTabsProps {}

const DocumentaryCastTabs: FunctionComponent<DocumentaryCastTabsProps> = () => {
  return (
    <>
                  ...
                  <ul className="list-inline swiper-wrapper">
                    <li className="swiper-slide">
                      <div className="cast-images m-0 row align-items-center position-relative">
                        <div className="col-4 img-box p-0">
                          <img
                            src="assets/images/genre/g1.html"
                            className="img-fluid"
                            alt="image"
                            loading="lazy"
                          />
                        ...
                        <div className="col-8 block-description">
                          <h6 className="iq-title">
                            <a href="person-detail.html" tabIndex={0}>
                              James Chinlund{" "}
                            </a>
                          </h6>
                    ...
                    <li className="swiper-slide">
                      <div className="cast-images m-0 row align-items-center position-relative">
                        <div className="col-4 img-box p-0">
                          <img
                            src="assets/images/genre/g2.html"
                            className="img-fluid"
                            alt="image"
                            loading="lazy"
                          />
                  ...
                  <ul className="list-inline swiper-wrapper">
                    <li className="swiper-slide">
                      <div className="cast-images m-0 row align-items-center position-relative">
                        <div className="col-4 img-box p-0">
                          <img
                            src="assets/images/genre/g3.html"
                            className="img-fluid"
                            alt="image"
                            loading="lazy"
                          />
                    ...
                    <li className="swiper-slide">
                      <div className="cast-images m-0 row align-items-center position-relative">
                        <div className="col-4 img-box p-0">
                          <img
                            src="assets/images/genre/g5.html"
                    ...
                    <li className="swiper-slide">
                      <div className="cast-images m-0 row align-items-center position-relative">
                        <div className="col-4 img-box p-0">
                          <img
                            src="assets/images/genre/g4.html"
                            className="person__poster--image img-fluid"
                            alt="image"
                            loading="lazy"
                          />
...
export default DocumentaryCastTabs;
