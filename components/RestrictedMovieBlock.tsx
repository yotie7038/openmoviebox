...
interface RestrictedMovieBlockProps {
    
}
 
const RestrictedMovieBlock: FunctionComponent<RestrictedMovieBlockProps> = () => {
    return ( 

        <>
        <section className="related-movie-block">
  <div className="container-fluid">
    <div className="overflow-hidden">
      <div className="d-flex align-items-center justify-content-between px-3 pt-2 my-4">
        <h5 className="main-title text-capitalize mb-0">Related Movies</h5>
      </div>
                ...
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      ...
                      <img src="assets/images/movies/related/01.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
            ...
            <li className="swiper-slide">
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      <a href="movie-detail.html" className="position-absolute top-0 bottom-0 start-0 end-0"></a>
                      <img src="assets/images/movies/related/02.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
                    <div className="card-description with-transition">
                      <div className="cart-content">
                        <div className="content-left">
            ...
            <li className="swiper-slide">
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      <a href="movie-detail.html" className="position-absolute top-0 bottom-0 start-0 end-0"></a>
                      <img src="assets/images/movies/related/03.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
                    <div className="card-description with-transition">
                      <div className="cart-content">
                        <div className="content-left">
            ...
            <li className="swiper-slide">
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      <a href="movie-detail.html" className="position-absolute top-0 bottom-0 start-0 end-0"></a>
                      <img src="assets/images/movies/related/04.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
                    <div className="card-description with-transition">
                      <div className="cart-content">
                        <div className="content-left">
            ...
            <li className="swiper-slide">
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      <a href="movie-detail.html" className="position-absolute top-0 bottom-0 start-0 end-0"></a>
                      <img src="assets/images/movies/related/05.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
                    <div className="card-description with-transition">
                      <div className="cart-content">
                        <div className="content-left">
            ...
            <li className="swiper-slide">
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      <a href="movie-detail.html" className="position-absolute top-0 bottom-0 start-0 end-0"></a>
                      <img src="assets/images/movies/related/06.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
                    <div className="card-description with-transition">
                      <div className="cart-content">
                        <div className="content-left">
            ...
            <li className="swiper-slide">
                <div className="iq-card card-hover">
                  <div className="block-images position-relative w-100">
                    <div className="img-box w-100">
                      <a href="movie-detail.html" className="position-absolute top-0 bottom-0 start-0 end-0"></a>
                      <img src="assets/images/movies/related/07.html" alt="movie-card" className="img-fluid object-cover w-100 d-block border-0"/>
                    </div>
                    <div className="card-description with-transition">
                      <div className="cart-content">
                        <div className="content-left">
...
export default RestrictedMovieBlock;