...
interface RestrictedVideoBlockProps {
    
}
 
const RestrictedVideoBlock: FunctionComponent<RestrictedVideoBlockProps> = () => {
    return (  
        <>
  ...
  <div className="container-fluid">
    <div className="overflow-hidden">
      <div className="d-flex align-items-center justify-content-between px-3 pt-2 my-4">
        <h5 className="main-title text-capitalize mb-0">Related Videos</h5>
      </div>
...
export default RestrictedVideoBlock;